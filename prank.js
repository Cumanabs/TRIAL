...
function countPrankAction() {
  prankCounter++;

  if (prankCounter >= 3) {
    prankModal.classList.add("active");
  }
}

/* HITUNG CLICK */
document.addEventListener("click", countPrankAction);

/* HITUNG DRAG */
document.addEventListener("mouseup", countPrankAction);
